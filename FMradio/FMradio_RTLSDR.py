...
class FMradio_RTLSDR(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "FMradio (RTL-SDR)")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("FMradio (RTL-SDR)")
        ...
        self.settings = Qt.QSettings("GNU Radio", "FMradio_RTLSDR")
...
def main(top_block_cls=FMradio_RTLSDR, options=None):
